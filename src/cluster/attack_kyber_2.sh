#!/bin/bash
#SBATCH --job-name=attack_kyber_2
#SBATCH --output=outputs/attack_kyber_2_%j.out
#SBATCH --time=2-00:00:00
#SBATCH --cpus-per-task=32
#SBATCH --mem=128G
#SBATCH --partition=all

### TO BE RUN WITH: sbatch attack_kyber_2.sh ###

n=256
k=2
q=179067461

hw=13 # can also be set to 10 to beat FRESCA

max_size=50 # -1, 0 or from 30 to 512 (lower values use less memory)
reduction_samples=-1 # -1, 0.875, 437
